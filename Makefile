...
INPUT_ACTIONS_HXX = ${INC_DIR}/InputActions.hxx
INPUT_ACTIONS_OBJ = ${OBJ_DIR}/InputActions.o
INPUT_ACTIONS_SRC = ${SRC_DIR}/InputActions.cxx
...
${EXEC}: ${MAIN_OBJ} ${DEBUG_OBJ} ${GAME_ENGINE_OBJ} ${INPUT_ACTIONS_OBJ} ${INPUT_HANDLER_OBJ} ${RENDERER_OBJ} ${SPRITE_LOADER_OBJ}
	${CXX} -o $@ $^ ${LIBRARIES}
...
${GAME_ENGINE_OBJ}: ${GAME_ENGINE_SRC} ${GAME_ENGINE_HXX} ${DEBUG_HXX} ${RENDERER_HXX}
	${CXX} -c -o $@ $< ${LIB_INCLUDES} ${CXX_STD} ${WARNINGS} ${OPTIMIZE} ${DEBUG}

${INPUT_ACTIONS_OBJ}: ${INPUT_ACTIONS_SRC} ${INPUT_ACTIONS_HXX} ${DEBUG_HXX}
	${CXX} -c -o $@ $< ${LIB_INCLUDES} ${CXX_STD} ${WARNINGS} ${OPTIMIZE} ${DEBUG}

${INPUT_HANDLER_OBJ}: ${INPUT_HANDLER_SRC} ${INPUT_HANDLER_HXX} ${DEBUG_HXX} ${INPUT_ACTIONS_HXX}
	${CXX} -c -o $@ $< ${LIB_INCLUDES} ${CXX_STD} ${WARNINGS} ${OPTIMIZE} ${DEBUG}
